...
func (a *validatedAPIServer) WalkCommitSubvenance(request *pfs.WalkCommitSubvenanceRequest, server pfs.API_WalkCommitSubvenanceServer) (retErr error) {
	return errors.New("walk commit subvenance is unimplemented")
}

func (a *validatedAPIServer) WalkBranchProvenance(request *pfs.WalkBranchProvenanceRequest, server pfs.API_WalkBranchProvenanceServer) (retErr error) {
	return errors.New("walk branch provenance is unimplemented")
}

func (a *validatedAPIServer) WalkBranchSubvenance(request *pfs.WalkBranchSubvenanceRequest, server pfs.API_WalkBranchSubvenanceServer) (retErr error) {
