...
type APIClient interface {
	...
	// WalkCommitProvenance starts from one or more commits and returns a stream of all commits that are transitively provenant on that commit.
	...
	// WalkCommitSubvenance starts from one or more commits and returns a stream of all commits that are transitively subvenant on that commit.
...
func (c *aPIClient) WalkCommitProvenance(ctx context.Context, in *WalkCommitProvenanceRequest, opts ...grpc.CallOption) (API_WalkCommitProvenanceClient, error) {
	stream, err := c.cc.NewStream(ctx, &API_ServiceDesc.Streams[3], API_WalkCommitProvenance_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *aPIClient) WalkCommitSubvenance(ctx context.Context, in *WalkCommitSubvenanceRequest, opts ...grpc.CallOption) (API_WalkCommitSubvenanceClient, error) {
	stream, err := c.cc.NewStream(ctx, &API_ServiceDesc.Streams[4], API_WalkCommitSubvenance_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *aPIClient) InspectCommitSet(ctx context.Context, in *InspectCommitSetRequest, opts ...grpc.CallOption) (API_InspectCommitSetClient, error) {
	stream, err := c.cc.NewStream(ctx, &API_ServiceDesc.Streams[5], API_InspectCommitSet_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *aPIClient) ListCommitSet(ctx context.Context, in *ListCommitSetRequest, opts ...grpc.CallOption) (API_ListCommitSetClient, error) {
	stream, err := c.cc.NewStream(ctx, &API_ServiceDesc.Streams[6], API_ListCommitSet_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *aPIClient) FindCommits(ctx context.Context, in *FindCommitsRequest, opts ...grpc.CallOption) (API_FindCommitsClient, error) {
	stream, err := c.cc.NewStream(ctx, &API_ServiceDesc.Streams[7], API_FindCommits_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
